...
```javascript
kernelSincos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-kernel-sincos@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-special-kernel-sincos/tags). For example,

```javascript
kernelSincos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-kernel-sincos@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var kernelSincos = require( 'path/to/vendor/umd/math-base-special-kernel-sincos/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-kernel-sincos@umd/browser.js"></script>
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/math-base-special-kernel-sincos.svg
[dependencies-url]: https://david-dm.org/stdlib-js/math-base-special-kernel-sincos/main
...
[deno-url]: https://github.com/stdlib-js/math-base-special-kernel-sincos/tree/deno
[deno-readme]: https://github.com/stdlib-js/math-base-special-kernel-sincos/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-base-special-kernel-sincos/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-base-special-kernel-sincos/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-base-special-kernel-sincos/tree/esm
